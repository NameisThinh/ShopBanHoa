...
export const ORDER_PREW_DETAILS_REQUEST = 'ORDER_PREW_DETAILS_REQUEST'
export const ORDER_PREW_DETAILS_SUCCESS = 'ORDER_PREW_DETAILS_SUCCESS'
export const ORDER_PREW_DETAILS_FAIL = 'ORDER_PREW_DETAILS_FAIL'
