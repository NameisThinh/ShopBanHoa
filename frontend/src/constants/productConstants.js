...
export const ASC_PRODUCT_REQUEST = 'ASC_PRODUCT_REQUEST'
export const ASC_PRODUCT_SUCCESS = 'ASC_PRODUCT_SUCCESS'
export const ASC_PRODUCT_FAIL = 'ASC_PRODUCT_FAIL'

export const DESC_PRODUCT_REQUEST = 'DESC_PRODUCT_REQUEST'
export const DESC_PRODUCT_SUCCESS = 'DESC_PRODUCT_SUCCESS'
export const DESC_PRODUCT_FAIL = 'DESC_PRODUCT_FAIL'
